 ...
 */
@Immutable
@Table(name = "payments_simple_view")
@Entity
@Data
@ToString
class PaymentsSimpleView protected constructor() {
  @Id
  @Column(name = "id", nullable = false)
  var id: Long? = null

  @Column(name = "row_num", nullable = false)
  var row_num: Long? = null
  ...
  var tenantMoveInDate: Instant? = null

  @Column(name = "tenant_move_out_date")
  var tenantMoveOutDate: Instant? = null
